...
def sign_and_parity(num):
    ...
    num_info = [sign, parity]

    return num_info

sign_300 = sign_and_parity(300)[0]

parity_300 = sign_and_parity(300)[1]
...
def write_letter(recip, job, sender):


    print("Dear {}, I think you are amazing! Sincerely, {}".format((full_title("Jane Hacks", "Hacker")), sender)
